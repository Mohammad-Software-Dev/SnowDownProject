...
func _init() -> void:
	var idle := ThirdPersonPose.resolve(0.0, 0.0, false, SnowballActionComponent.HANDS_FREE, 0.0, 0.0, 0.0)
	var moving := ThirdPersonPose.resolve(7.5, 0.0, false, SnowballActionComponent.HANDS_FREE, 0.0, 1.0, 0.0)
	...
	var crouched := ThirdPersonPose.resolve(0.0, 0.0, true, SnowballActionComponent.HANDS_FREE, 0.0, 0.0, 0.0)
	...
	var airborne := ThirdPersonPose.resolve(5.0, 3.0, false, SnowballActionComponent.HANDS_FREE, 0.0, 1.0, 0.0)
	...
	var packing := ThirdPersonPose.resolve(0.0, 0.0, false, SnowballActionComponent.PACKING, 0.0, 0.0, 0.0)
	...
	var charge_low := ThirdPersonPose.resolve(0.0, 0.0, false, SnowballActionComponent.THROW_CHARGING, 0.0, 0.0, 0.0)
	var charge_high := ThirdPersonPose.resolve(0.0, 0.0, false, SnowballActionComponent.THROW_CHARGING, 1.0, 0.0, 0.0)
	...
	var recovering := ThirdPersonPose.resolve(0.0, 0.0, false, SnowballActionComponent.THROW_RECOVERING, 0.0, 0.0, 0.0)
	_assert_true(Vector3(recovering["right_arm_rotation"]).x < -1.2, "throw recovery follows through")

	var catching := ThirdPersonPose.resolve(0.0, 0.0, false, SnowballActionComponent.CATCHING, 0.0, 0.0, 0.0)
	...
	var reaction := ThirdPersonPose.resolve(0.0, 0.0, false, SnowballActionComponent.HANDS_FREE, 0.0, 0.0, 1.0)
